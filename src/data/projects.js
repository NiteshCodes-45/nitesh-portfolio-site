const projects = [
    {
      title: "FoodCart",
      description: "Browse and filter Indian dishes, add to cart, and place your order with ease.",
      image: "./projects/homepage-foodcart.png",
      link: "#",
      tags: ['React', 'HTML', 'CSS'],
      type: "web",
    },
    {
      ...
      description: "Stay updated with live cricket scores, player stats, and match summaries.",
